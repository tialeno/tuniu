  ...
  <div class="wrapper"> 
   <div class="topic-box"> 
    ...
    <div class="topic-info clearfix"> 
     ...
     <a id="userPic" href="javascript:;" class="user-pic" m="点击_游记详情页_顶部_作者头像_71137194_查看个人主页"> <img src="{{$article->thumb}}" /> </a> 
     <div class="detail-title"> 
      <h1>{{$article->title}}</h1> 
     </div> 
     <div class="detail-info clearfix"> 
      <div class="user-info"> 
       <a id="userName" href="javascript:;" m="点击_游记详情页_顶部_作者头像_71137194_查看个人主页"> <p class="user-name">From : {{$article->source}}</p> </a> 
      </div> 
        ...
        <div class="col-sidebar">
          ...
          <div data-v-546637ed="" class="side-floor">
           <div data-v-546637ed="" class="side-topic">
            ...
            <a data-v-546637ed="" href="/home/goodsinfo/{{$goodsinfo->id}}" class="side-link">爆款 &gt;</a>
           </div> 
           <div data-v-546637ed="" class="side-main">
            <ul data-v-546637ed="" class="product-list clearfix" style="transform: translate(0px, 0px);">
              <li data-v-546637ed="">
                <a data-v-546637ed="" href="/home/goodsinfo/{{$goodsinfo->id}}" target="_blank" class="product-li-card">
                  <div data-v-546637ed="" class="prd-image">
                    <img data-v-546637ed="" src="{{$goodsinfo->pic}}" width="225" height="150" />
                   </div> 
                   <div data-v-546637ed="" class="prd-name">
                    &lt;{{$goodsinfo->title}}&gt;
                   </div> 
                   <div data-v-546637ed="" class="prd-info">
                    <span data-v-546637ed="" class="price"><em data-v-546637ed="">￥</em><span data-v-546637ed="" class="big">{{$goodsinfo->price}}</span>起</span> 
                    <span data-v-546637ed="" class="satisfaction">{{$satisfied}}%满意度</span>
                  </div>
                </a>
              </li>
            </ul> 
          ...
          <div class="fix-sider" style="position: relative; top: 0px;">
           ...
           <div class="trip-catalog">
            ...
            <ul class="catalog-list" style="max-height: 644px; overflow-y: auto;">
             @foreach($article_other as $k=>$v)
             <li><a href="/home/article/index/{{$v->id}}"><span class="li-nav">@if($i < 10) 0{{$i++}} @else $i++ @endif</span><span class="li-cont">{{$v->title}}</span></a></li>
             @endforeach
            </ul>
           </div>
          </div>
