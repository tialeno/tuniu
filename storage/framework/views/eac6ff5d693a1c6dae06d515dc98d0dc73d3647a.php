...
<div class="margin clearfix">
 <div class="defray_style">
    ...
    <div class="border clearfix">
     <span class="l_f">
        <a href="javascript:ovid()" onclick="add_payment()" class="btn btn-primary Pay_add"><i class="fa fa-credit-card"></i>&nbsp;添加商品</a>
       </span>
    </div>
    <!--商品列表-->
...
<div style="margin:0 auto;text-align:center" id="list"><?php echo e($goods->links()); ?></div>
<!--添加商品-->
