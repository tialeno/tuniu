...
<link rel="stylesheet" type="text/css" href="/uploadify/uploadify.css">
    ...
    <div class="mainDiv">
        <div class="header_box">
            ...
            <div class="left oh">
                ...
                <h1 class="header-order-name" id="gid" title="315"><?php echo e($goodsinfo->title); ?></h1>
    ...
    <script>
        ...
        ?>
        alert("<?php echo e(asset('/uploadify/uploadify.swf')); ?>");
        // 文件上传
        $(function() {
            $('#file_upload').uploadify({
                ...
                'swf'      : "<?php echo e(url('/uploadify/uploadify.swf')); ?>",
