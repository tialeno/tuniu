...
class Navigate_FirstController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.navigate_first.index',['data'=>$data,'i'=>$i,'offset'=>$offset,'num'=>$num]);
    }
    ...
    public function show(Request $request,$id)
    {
        ...
        // 初始编号
        $i = 1;
        return view('admin.navigate_first.childlist',['data'=>$data,'num'=>$num,'i'=>$i,'offset'=>$offset]);
    }
    ...
    public function getAllNavigate(){
        //显示所有顶级分类
        $data = Navigate_First::where('pid','=','0')->get();
        // 分类数
        $num = count($data);

        return view('admin.navigate_first.index',['data'=>$data,'num'=>$num]);
    }
